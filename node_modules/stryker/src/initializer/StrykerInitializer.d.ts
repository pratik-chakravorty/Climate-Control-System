...
export default class StrykerInitializer {
    ...
    */
    ...
    private selectTestFramework(testRunnerOption);
    private selectMutator();
    private selectTranspilers();
    private getSelectedNpmDependencies(selectedOptions);
    /**
    * Install the npm packages
    * @function
    */
    private installNpmDependencies(dependencies);
    private fetchAdditionalConfig(dependencies);
}
